...
/**
 * @author Jason Song(song_s@ctrip.com) 提供 Release 的 Service 逻辑给 Admin Service 和 Config Service 。
 */
@Service
public class ReleaseService {
  ...
  public Release publish(Namespace namespace, String releaseName, String releaseComment,
    ...
    //merge to branch and auto release // 若有子 Namespace 时，自动将主干合并到子 Namespace ，并进行一次子 Namespace 的发布
    if (childNamespace != null) {
